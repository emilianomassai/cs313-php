...
//CHANGED AFTER LOOKING AT THE SOLUTION. In the colorValidating() function, I
//used a switch statement to check for the prompted values, but in the solution
...
function colorValidating() {
  ...
  document.getElementById("first_div").style.color = colorFromUser;
  $("#second_div").css("background-color", colorFromUser);
